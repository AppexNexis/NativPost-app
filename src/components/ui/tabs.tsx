...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // max-w-full + overflow-x-auto: the triggers are whitespace-nowrap, so a
      // list of 4+ tabs otherwise grew past a phone's width and took the whole
      // page into a sideways scroll. Now the strip scrolls inside itself.
