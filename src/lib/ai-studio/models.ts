...
export const AI_STUDIO_MODELS: AiStudioModel[] = [
  ...
  },
  {
    ...
    label: 'Krea 2 Turbo',
    kind: 'image',
    falModel: 'fal-ai/krea-2/turbo',
    credits: 3,
    aspects: ['1:1', '9:16', '16:9', '4:5'],
    costUsd: 0.01,
    description: 'Fast, high-quality text-to-image (speed-optimized).',
  },
  {
    id: 'krea-2-turbo-style',
    label: 'Krea 2 Turbo (Style)',
    kind: 'image',
    falModel: 'fal-ai/krea-2/turbo/style',
    credits: 4,
    aspects: ['1:1', '9:16', '16:9', '4:5'],
    requiresImage: true,
    costUsd: 0.012,
    description: 'Style-locked text-to-image. Upload up to 4 reference images.',
  },
  {
    id: 'gpt-image-2',
    label: 'GPT Image 2',
  ...
  {
    id: 'happy-horse-i2v',
    label: 'Happy Horse v1.1',
    kind: 'video',
    falModel: 'alibaba/happy-horse/v1.1/image-to-video',
    credits: 20,
    perSecond: true,
    aspects: ['9:16', '1:1', '16:9', '4:5'],
    durations: [5, 3, 8, 10, 15],
    requiresImage: true,
    costUsd: 0.90,
    description: '1080p i2v with native audio and multilingual lip-sync. Write dialogue in the prompt.',
  },
  {
    id: 'kling-v3-pro-i2v',
    label: 'Kling V3 Pro',
    ...
    requiresImage: true,
    costUsd: 0.84,
    description: 'Cinematic i2v with native audio. Premium tier.',
  },
  {
    id: 'seedance-2-i2v',
