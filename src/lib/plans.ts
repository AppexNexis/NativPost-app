...
export const PLAN_CONFIGS: Record<string, PlanConfig> = {
  ...
  starter: {
    ...
    polarProductId: { dev: 'polar_STARTER_SANDBOX_REPLACE', prod: '099faa4d-14a4-4a0f-836f-d68a78fb7bc1' },
    polarAnnualProductId: { dev: 'polar_STARTER_ANNUAL_SANDBOX_REPLACE', prod: '8d4863da-fde7-4bf9-82be-13126c010534' },
  ...
  growth: {
    ...
    polarProductId: { dev: 'polar_GROWTH_SANDBOX_REPLACE', prod: '371f8d43-a574-43ca-896a-f73aec413a8f' },
    polarAnnualProductId: { dev: 'polar_GROWTH_ANNUAL_SANDBOX_REPLACE', prod: 'd43d9411-cb23-45b4-8a53-b951d9427c1a' },
  ...
  pro: {
    ...
    polarProductId: { dev: 'polar_PRO_SANDBOX_REPLACE', prod: 'cb4f98f9-7c8f-48b2-9b0f-ee1c35e10601' },
    polarAnnualProductId: { dev: 'polar_PRO_ANNUAL_SANDBOX_REPLACE', prod: 'ef0a670a-acd4-4cd7-bc59-2bc9ca4508c4' },
  ...
  agency: {
    ...
    polarProductId: { dev: 'polar_AGENCY_SANDBOX_REPLACE', prod: 'a38b11af-096e-44bf-8cdb-1c70cb8503a3' },
    polarAnnualProductId: { dev: 'polar_AGENCY_ANNUAL_SANDBOX_REPLACE', prod: 'eba7b992-c0ac-476b-a353-20e6e2a30238' },
